            ...
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">
                  WearKart Multi Vendor Ecommerce Platform.
                </h1>
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img src="\projects\wearkart/home.png" alt="Home Page" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/productFilter.png"
                        alt="Wearkart Product Filter"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/adminPanel.png"
                        alt="Admin Panel"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="\projects\wearkart/productDetail.png" alt="" />
                    </SwiperSlide>
                  </div>
