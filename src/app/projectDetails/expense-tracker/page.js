          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Expense Tracker</h1>
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://expensetracker.sintechworks.com/"
                          target="_blank"
                        >
                          expensetracker.sintechworks.com
                        </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://github.com/apsingh03/ExpenseTrackerApp"
                          target="_blank"
                        >
                          Click Here
                        </a>
          ...
          <div className="portfolio-details-post-thumb-slider">
            <div className="row">
              <div className="col-lg-12">
                <p className="fs-4 text-center m-1">Website </p>
                <Swiper
                  {...settings}
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/web/signUpPageDesktopMode.png"
                        alt="Sign Up"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/web/backend.png"
                        alt=""
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/web/fullSizeScreenshot.png"
                        alt=""
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/web/addExpenseWebApp.png"
                        alt=""
                      />
                    </SwiperSlide>
                  </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <p className="fs-4 text-center m-1">Android </p>
                <Swiper
                  {...settings}
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/android/signup.png"
                        alt="Sign Up"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/android/homeTab.png"
                        alt=""
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/android/addExpenses.png"
                        alt=""
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/expensetracker/android/addCategoryTab.png"
                        alt=""
                      />
                    </SwiperSlide>
                  </div>
