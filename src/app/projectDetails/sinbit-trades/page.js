          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Sinbit Trades Web App</h1>
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://sinbittrades.sintechworks.com/"
                          target="_blank"
                        >
                          sinbittrades.sintechworks.com
                        </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://github.com/apsingh03/Trading-Blogs"
                          target="_blank"
                        >
                          Click Here
                        </a>
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img src="\projects\sinbit/home.png" alt="Home Page" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\sinbit/AdminPanelDashboard.png"
                        alt="Admin Panel"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\sinbit/Calculator.png"
                        alt="Admin Panel"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\sinbit/learning.png"
                        alt="Admin Panel"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\sinbit/AdminPanelAllBlogs.png"
                        alt="Admin Panel"
                      />
                    </SwiperSlide>
                  </div>
