          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">WearKart Android App</h1>
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://drive.google.com/file/d/1xz4wjAfOuax4UIc4OdN9kXr6656iaBtO/view?usp=drive_link"
                          target="_blank"
                        >
                ...
                >
                  <div className="swiper-wrapper ">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/android/splash.jpeg"
                        alt="Splash Screen"
                        height={600}
                        // width={300}
                      />
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/android/signup.jpeg"
                        alt="Sign Up Screen"
                        height={600}
                        // width={300}
                      />
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/android/home.jpeg"
                        alt="Home Screen"
                        height={600}
                        // width={300}
                      />
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/android/productdetail.jpeg"
                        alt="Product Details"
                        height={600}
                        // width={300}
                      />
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="\projects\wearkart/android/filter.jpeg"
                        alt="Product Filter"
                        height={600}
                        // width={300}
                      />
...
export default WearKartAndroidApp;
