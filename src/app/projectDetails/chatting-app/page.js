          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Chatting App</h1>
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://chatting.sintechworks.com"
                          target="_blank"
                        >
                          chatting.sintechworks.com
                        </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <a
                          href="https://github.com/apsingh03/ChatApp"
                          target="_blank"
                        >
                          Click Here
                        </a>
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/chat/SignUpPage.png"
                        alt="Sign Up Page"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/chat/swagger.png"
                        alt="Sign Up Page"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/chat/ChattingDashboardPage.png"
                        alt="Sign Up Page"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/chat/userCanSendImages.png"
                        alt="Sign Up Page"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/chat/TabletModebreakpoint.png"
                        alt="Sign Up Page"
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/projects/chat/mobilemodebreakpoint.png"
                        alt="Mobile Mode"
                      />
                    </SwiperSlide>
                  </div>
