          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Personal Portfolio</h1>
                <ul className="post-category">
                  {["React Js", "Responsive Design", "Animation"].map(
                    (tag, idx) => {
                      return (
                        <li key={idx}>
                          <Link href="/">{tag}</Link>
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>Website:</td>
                      <td>
                        <a href="ajaypratapsingh.online/" target="_blank">
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img src="\projects\portfolio/home.png" alt="Home " />
                    </SwiperSlide>
                  </div>
