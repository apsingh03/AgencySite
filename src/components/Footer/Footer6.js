          ...
          <div className="row justify-content-center mb-70">
            <div className="col-lg-7">
              <div className="footer-top">
                ...
                <p>
                  Enables businesses to build and strengthen relationships with
                  customers.
                </p>
                  ...
                  <div className="col-lg-6 col-md-8 d-flex justify-content-lg-start">
                    <div className="footer-widget">
                      ...
                      <div className="footer-content">
                        <p>
                          Axleo is a comprehensive Project Management Software
                          as a Serviceproduct designed to empower teams to plan,
                          execute, and track projects efficiently.
                        </p>
                      </div>
