    ...
    <>
      ...
      <header className={`header-area style-1 ${style}`}>
        <div className="header-logo">
          ...
          <Link href="/" className="text-dark fs-4">
            {/* <img
              alt="image"
            ...
            <ul className="menu-list">
              <li className="menu-item-has-children">
                ...
                <ul className="sub-menu">
                  <li>
                    <Link href="/services1">WebApp Development</Link>
                  </li>
                  <li>
                    <Link href="/service2">Android Development</Link>
                  </li>
                  <li>
                    <Link href="/service3">IOS Development</Link>
                  </li>
                  <li>
                    <Link href="/service4">UI & UX Designing</Link>
                  </li>
                </ul>
              </li>
