              ...
              <div className="section-title text-animation">
                ...
                <div className="dash-and-paragraph">
                  ...
                  <div className="content-and-social">
                    <p>
                      Our ambitions reach for the moon and extend beyond the
                      Milky Way galaxy. With determination as our compass,we
                      chart a course towards limitless horizons. Fill the form
                      and connect with us or directly call us or drop a message
                    </p>
